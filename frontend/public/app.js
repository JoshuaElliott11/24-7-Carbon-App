...
const INFO_TEXT = {
  ...
  "adjacent-zone cost multiplier": "Optional project-specific cost multiplier for adjacent-zone resources. Leave at 1.0 when no premium or discount applies.",
...
function projectPayload() {
  return {
    ...
    adjacent_zone_cost_multiplier: Number(document.getElementById("adjacent-zone-cost-multiplier").value || 1),
